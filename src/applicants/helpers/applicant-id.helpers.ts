...
import { ApplicantIdCounter } from "../ApplicantIdCounter";
import { shortCodes } from "./shortCodes.data";
...
export const generateApplicantId = async (
  ...
  try {
    const counter: any = await ApplicantIdCounter.findOne({
      where: { prefix },
    });
...
export { getVillageCode, getWardKey };
